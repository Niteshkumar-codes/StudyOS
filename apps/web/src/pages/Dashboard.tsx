        ...
        <div className="xl:col-span-2 border border-zinc-200/80 dark:border-zinc-800/80 rounded-2xl bg-white dark:bg-[#121215] p-5 shadow-sm space-y-4">
          ...
          <div className="rounded-2xl border border-zinc-200 dark:border-zinc-800 p-4 bg-zinc-50/60 dark:bg-zinc-900/20 space-y-3">
            <div className="flex items-center justify-between gap-3 flex-wrap">
              <div>
                ...
                <p className="text-[11px] text-zinc-500 dark:text-zinc-400 mt-1">
                  Quick access to the notes workspace.
                </p>
              </div>
              <button
                type="button"
                onClick={() => navigate('/notes')}
                className="inline-flex items-center gap-2 px-3 py-1.5 rounded-xl border border-zinc-200 dark:border-zinc-800 text-[11px] font-semibold text-zinc-600 dark:text-zinc-400 hover:bg-zinc-50 dark:hover:bg-zinc-800/60 transition-colors"
              >
                Open Notes
              </button>
            </div>
            ...
            {summary?.recentNotes?.length ? (
              <div className="space-y-2">
                {summary.recentNotes.slice(0, 3).map((note) => (
                  <button
                    ...
                    type="button"
                    onClick={() => navigate('/notes')}
                    className="w-full text-left rounded-xl border border-zinc-200 dark:border-zinc-800 px-3 py-2 bg-white dark:bg-[#18181c] hover:bg-zinc-50 dark:hover:bg-zinc-800/50 transition-colors"
                  >
              ...
              <div className="rounded-xl border border-dashed border-zinc-200 dark:border-zinc-800/80 p-4 text-center text-xs text-zinc-500 dark:text-zinc-400 bg-white/60 dark:bg-zinc-900/20">
                No notes yet.
              </div>
            )}
          </div>
